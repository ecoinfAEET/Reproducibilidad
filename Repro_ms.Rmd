...
---quizas este parrafo no pertenece al paper, lo podemos cortar---
El propio escrito inicial del proyecto, aparte de para pedir financiación, sirve para poner por escrito hipotesis a testar y una hoja de ruta que describe por que, que y como queremos realizar el proyecto. De hecho, diversos autores estan tomando la iniciativa de publicar abiertamente estos proyectos para asegurar la transparencia del proceso, para legitimizar la atribución de las ideas contenidas, y sobretodo, para que quede un registro de nuestras intenciones que se puedan confrontar con los resultados obtenidos (E. White webpage). En otras disciplinas, aun se va más allá, y el pre-registro de experimentos es una practica habitual (ref). Esto es importante por que asegura que no cambies tus hipotesis en funcion de los resultados, es decir, asegura que tus intenciones son reproducidas por tus aciones. Sin ir tan lejos, escribir protocolos detallados antes de coger los datos, y actualizarlos con las eventualidades que en ecologia siempre surgen, es el primer paso para poder reproducir el proceso que se ha seguido. Esto lleva tiempo, y es tentador explicar verbalmente que datos vamos a tomar al equipo de trabajo, pero es la unica forma de dejar un registro, y no olvidar ningún detalle en la sección de "Material y metodos". Sobra decir, que preparar tablillas pre-definidas para entrar datos en campo tambien asegura que no nos dejaremos ningun dato relevante.
